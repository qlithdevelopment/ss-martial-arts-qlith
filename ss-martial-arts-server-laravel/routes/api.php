...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:admin,student')->group(function () {
        ...
        Route::get('/students/{studentId}/payments', [StudentPaymentController::class, 'studentPayments']);
        Route::patch('/users/{id}/payment-status', [StudentController::class, 'updatePaymentStatus']);
        Route::get('/student/my-batch', [StudentController::class, 'myBatch']);
        Route::get('/students/{id}', [StudentController::class, 'show']);
        Route::get('/student/avatar/{id}', [StudentController::class, 'getAvatar']);
        Route::put('/student/avatar/{id}', [StudentController::class, 'updateAvatar']);
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('/students/{studentId}/payments', [StudentPaymentController::class, 'store']);
        Route::get('/student-payments/{id}', [StudentPaymentController::class, 'show']);
        Route::put('/student-payments/{id}', [StudentPaymentController::class, 'update']);
        Route::delete('/student-payments/{id}', [StudentPaymentController::class, 'destroy']);
