    ...
    <footer className="w-full bg-black h-auto lg:pt-12 flex flex-col justify-between pt-8 pb-4 border-t border-white/10 relative z-50 overflow-hidden">
      <div className="global-container lg:!px-22 flex-1 flex flex-col justify-center relative z-10">
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 md:gap-x-6 gap-x-6 gap-y-6 md:gap-12 mb-4"
        >
          {/* BRANDING */}
          <div className="col-span-2 md:col-span-1 flex flex-col items-start mr-10">
            <Link to="/" className="flex items-center gap-4  mb-2 md:mb-4">
              <img
                src={Logo}
                alt="Logo"
                className="w-24 md:-mt-8 md:w-52 object-contain"
              />
            </Link>
            <p className="text-secondary  leading-relaxed mb-2 md:mb-4 mt-5">
              Building stronger bodies, sharper minds, and confident individuals
              through quality martial arts training, discipline, and a
          ...
          <div className="col-span-1">
            <h4 className="text-white font-bold tracking-widest uppercase mb-2 md:mb-4 text-[10px] md:text-base">
              Quick Links
            </h4>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="flex flex-col gap-2 md:gap-4 text-[10px] md:text-sm text-secondary">
              <li className="flex items-start gap-2 md:gap-3">
                ...
                <span>
                  Near Ekramra College, Sundarpada, Bhubaneswar, Odisha 751002
                </span>
              </li>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-secondary text-[9px] md:text-xs flex-1 lg:text-start text-start">
            &copy; {new Date().getFullYear()} SS Martial Arts School. All rights
            reserved. <span className="mx-1 md:mx-2 text-white/20">|</span>{" "}
            Developed by{" "}
            <a
