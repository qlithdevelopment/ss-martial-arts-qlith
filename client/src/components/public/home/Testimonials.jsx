...
const Testimonials = () => {
  ...
  return (
    <section ref={targetRef} id="testimonials" className="relative h-[300vh] bg-white">
          ...
          >
            ...
            <React.Fragment key={setIndex}>
              ...
              <div className="flex flex-col gap-4 md:gap-6 shrink-0 h-auto w-[260px] xl:w-[300px] justify-center py-6">
                ...
                {/* Card 3: Down Bubble */}
                <div className="bg-white rounded-[20px] p-5 xl:p-6 shadow-2xl relative bubble-down mt-2 h-auto">
              ...
              <div className="flex flex-col gap-4 md:gap-6 shrink-0 h-auto w-[240px] xl:w-[280px] justify-center py-6">
                ...
                {/* Card 6: Small Bubble */}
                <div className="bg-white rounded-[20px] p-5 xl:p-6 shadow-2xl relative bubble-down mt-6 xl:mt-8 flex flex-col items-center h-auto">
                  <div className="absolute -top-[24px] xl:-top-[30px] left-1/2 -translate-x-1/2">
                    <img src={testimonialsData[5].image} className="w-10 h-10 xl:w-12 xl:h-12 rounded-full border-[3px] border-white shadow-2xl shrink-0" alt="User" />
                  </div>
                  <div className="mt-4">
              ...
              <div className="flex flex-col gap-4 md:gap-6 shrink-0 h-auto w-[280px] xl:w-[340px] justify-center py-6 pt-12">
                {/* Card 7: Wide Top */}
                <div className="bg-white rounded-[20px] p-5 xl:p-6 shadow-2xl relative bubble-up h-auto mt-2">
                ...
                <div className="bg-white rounded-[20px] p-5 xl:p-6 shadow-2xl flex items-center justify-between gap-4 h-auto">
                  ...
                  <div className="flex flex-col items-center shrink-0">
                    <img src={testimonialsData[8].image} className="w-10 h-10 xl:w-14 xl:h-14 rounded-full object-cover shadow-2xl mb-1 xl:mb-2 shrink-0" alt="User" />
