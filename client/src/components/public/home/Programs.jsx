          ...
          >
            ...
            <div className="w-full bg-white p-8 flex flex-col relative">
              ...
              <div className="mt-8 overflow-hidden h-6 flex items-center">
                <div className="flex items-center gap-2 text-[#0b1b24] font-bold text-sm tracking-wide transform translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
