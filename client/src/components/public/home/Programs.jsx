...
const Programs = () => {
  ...
  return (
    <section
      id="programs"
      className="w-full min-h-screen bg-[#f8f9fa] flex flex-col justify-center items-center pt-16 pb-12 md:pt-24 md:pb-16 lg:pt-32 lg:pb-24"
    >
      <div className="global-container !px-0  w-full z-10 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            Whether you're looking for flexible access, personalized coaching,
            or energetic group sessions, we have the perfect training
            environment for you.
          </p>
        </motion.div>
        ...
        >
          {showprogram.map((program) => (
            ...
            >
              {/* TOP IMAGE HALF */}
              <Link to={`/programdetail/${program.id}`}>
                ...
                {/* BOTTOM DETAILS HALF */}
                <div className="w-full bg-white p-6 justify-end flex flex-col relative flex-1">
                  <div className="h-full flex flex-col justify-start">
                    <h3 className="text-2xl font-black text-[#1a1a1a] uppercase tracking-tight group-hover:text-[#26c0ff] transition-colors duration-300">
                      {program.title}
                    </h3>

                    <p className="text-gray-500 max-h-30 w-full break-words text-[13px] md:text-[13px]  font-medium leading-relaxed mb-6 line-clamp-3">
          ...
          <motion.div
            className="h-full lg:w-auto md:w-screen justify-center flex items-center"
            variants={cardVariants}
          >
            <Link
              to="/programs"
            ...
            >
              ...
              <p className="text-gray-400 text-[13px] md:text-sm font-medium leading-relaxed">
                Explore our full range of programs and find the perfect fit for
                you.
              </p>
            </Link>
          </motion.div>
