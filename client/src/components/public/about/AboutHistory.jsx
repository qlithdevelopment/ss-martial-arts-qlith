        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="w-full lg:w-1/2">
            <motion.div
              ...
              className="mb-10"
            >
              <h2 className="text-3xl md:text-4xl font-black text-[var(--color-primary)] uppercase tracking-tight mb-2">Our History</h2>
              <div className="w-12 h-1 bg-[var(--color-primary)] rounded-full"></div>
            </motion.div>

            <div className="relative border-l-2 border-[var(--color-primary)] ml-3 md:ml-4 space-y-8 pb-4">
              {historyData.map((item, idx) => (
                ...
                >
                  <div className="absolute w-4 h-4 rounded-full bg-[var(--color-primary)] border-4 border-[#f8f9fa] left-[-9px] top-1"></div>
                  <h3 className="text-lg font-black text-[var(--color-primary)]">{item.year} - {item.title}</h3>
          ...
          <div className="w-full lg:w-1/2">
            <motion.div
              ...
              className="mb-10"
            >
              <h2 className="text-3xl md:text-4xl font-black text-[var(--color-primary)] uppercase tracking-tight mb-2">Achievements</h2>
              <div className="w-12 h-1 bg-[var(--color-primary)] rounded-full"></div>
            </motion.div>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="mt-8 bg-gradient-to-r from-[var(--color-primary)] to-[#1a3644] rounded-2xl p-6 text-white overflow-hidden relative"
            >
