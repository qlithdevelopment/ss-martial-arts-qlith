    ...
    <section className="w-full bg-black flex items-center justify-center px-4 md:px-8 py-12 lg:py-24">
      ...
      <div className="global-container lg:!px-14 h-auto bg-gray-900 rounded-[30px] p-4 sm:p-6 md:p-8 shadow-[0_10px_40px_rgba(0,0,0,0.5)] flex flex-col lg:flex-row gap-8 lg:gap-12 border border-gray-800">
        ...
        <div className="w-full lg:w-[35%] flex flex-col gap-4 lg:gap-6 shrink-0 lg:sticky lg:top-24 lg:h-[calc(100vh-140px)]">
          ...
          >
            <div>
              <h4 className="text-[#0b1b24] font-black text-base mb-1">
                Let's Work Together :
              </h4>
        ...
        <div className="w-full lg:w-[65%] lg:flex-1 min-h-0 pb-4">
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              <span className="text-4xl text-gray-500 font-serif leading-none">
                "
              </span>
              <h2 className="text-4xl md:text-6xl font-black text-[#26c0ff] tracking-tight uppercase">
                HELLO.
              </h2>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-300 font-black tracking-widest text-sm mb-4">
                {instructorData.subtitle}
              </p>
              <div className="flex flex-wrap gap-2">
                {instructorData.badges.map((badge, idx) => (
                  <span
                    key={idx}
                    className="px-3 py-1 bg-[#26c0ff] text-[#0b1b24] text-[10px] font-bold rounded-md uppercase tracking-wider shadow-sm"
                  >
                    {badge}
                  </span>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 border-b-2 border-gray-800 pb-8">
            ...
            >
              <h3 className="text-lg font-black text-[#26c0ff] mb-4 border-b-2 border-[#26c0ff] inline-block pb-1">
                Details
              </h3>
              <div className="space-y-4">
                {instructorData.details.map((item, idx) => (
                  <div key={idx} className="flex flex-col">
                    ...
                    <span className="text-sm font-bold whitespace-pre-line text-gray-200">
                      {item.value}
                    </span>
                  </div>
                ))}
