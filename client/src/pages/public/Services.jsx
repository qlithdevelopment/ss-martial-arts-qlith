        ...
        {allServices.map((service, index) => (
          ...
          >
            ...
            <div className="w-full md:w-1/2 relative group">
              <div className="absolute inset-0 bg-[#26c0ff] translate-x-4 translate-y-4 rounded-3xl opacity-20 group-hover:translate-x-6 group-hover:translate-y-6 transition-transform duration-500"></div>
              <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                ...
                />
                <div className="absolute top-6 left-6 bg-[#f97316] text-white text-xs font-black px-4 py-2 uppercase tracking-widest rounded shadow-lg">
                  {service.badge}
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#26c0ff] uppercase tracking-tight mb-3">
                {service.title}
              </h2>
              <p className="text-[#f97316] text-sm md:text-base font-bold uppercase tracking-[0.2em] mb-6">
                {service.subtitle}
              </p>
              ...
              <ul className="space-y-3 mb-10 text-gray-700 font-semibold">
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#26c0ff]"></span> Beginner to Advanced Levels
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#26c0ff]"></span> Professional Coaching
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#26c0ff]"></span> Comprehensive Curriculum
                </li>
              </ul>
