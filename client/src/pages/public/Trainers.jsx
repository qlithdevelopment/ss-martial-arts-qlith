  ...
  return (
    <section className="w-full min-h-screen bg-white px-4 md:px-8 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="global-container lg:!px-14 relative z-10">
        ...
        {/* Bento Grid */}
        <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[220px] md:auto-rows-[300px] gap-6">
          {loading ? (
            ...
            instructors.map((item, idx) => (
              ...
              >
                <div className="relative rounded-[24px] overflow-hidden bg-white flex flex-col h-full">
                  {/* TOP: Photo section */}
                  <div className="relative w-full h-full md:h-[85%] bg-gray-50 flex items-center justify-center shrink-0 overflow-hidden">
                    {item.image ? (
                      <img
                        src={item.image}
                        alt={item.name}
