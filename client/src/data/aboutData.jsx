...
export const faqData = [
  {
    ...
    answer: "Not at all! We have classes tailored for absolute beginners where we teach fundamental movements, as well as advanced classes for seasoned practitioners."
  },
  {
    question: "What equipment do I need for my first class?",
    answer: "For your first trial class, just wear comfortable athletic clothing. If you decide to join, we will guide you on purchasing the specific uniform (Gi) or gear required for your chosen discipline."
  },
  {
  ...
  },
  {
    ...
    answer: "We recommend attending at least 2 to 3 classes per week to build muscle memory and maintain steady progress. Consistency is the key to martial arts."
  },
  {
